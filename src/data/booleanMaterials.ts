export const booleanMaterials = [
    {
      ...
      content_5:
        "Fungsi Boolean adalah ekspresi yang terdiri dari variabel Boolean dan operator logika.\n" +
        "Contoh: F(A, B, C) = A × B + C\n" +
        "Fungsi ini digunakan untuk merepresentasikan logika dalam sirkuit digital.",
