    ...
    return (
        <div className='max-w-5xl mx-auto px-6 py-12 flex flex-col gap-6'>
            ...
            {booleanMaterials.map((item, index) => (
                <div key={index} className="bg-white/5 backdrop-blur p-6 rounded-xl border border-white/10 shadow-md">
                    {item.title && (
                    ...
                    {item.content_1 && (
                        <p className="text-sm text-white/90 mb-4 whitespace-pre-line">
                            {item.content_1}
                        </p>
                    )}
                    {item.title_2 && (
                    ...
                    {item.content_3 && (
                        <pre className="text-sm text-white/90 mb-4 whitespace-pre-line font-mono">
                            {item.content_3}
                        </pre>
                    )} */}
                    {item.title_4 && (
